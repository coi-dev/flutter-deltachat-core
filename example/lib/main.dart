...
/*
        ...
        _addListItem(text: "isConfigured", assertion: false, result: isConfigured2);
        await context2.setConfigValue("addr", "bob@mailserver.vagrant", ObjectType.String);
        _addListItem(text: "setConfigValue addr bob@mailserver.vagrant");
        String getConfigAddrValue2 = await context2.getConfigValue("addr");
        _addListItem(text: "getConfigValue addr", assertion: "bob@mailserver.vagrant", result: getConfigAddrValue2);
        await context2.setConfigValue(Context.configDisplayName, "Bob", ObjectType.String);
        _addListItem(text: "setConfigValue displayname Bob");
        String getConfigDisplayNameValue2 = await context2.getConfigValue(Context.configDisplayName);
        _addListItem(text: "getConfigValue displayname", assertion: "Bob", result: getConfigDisplayNameValue2);
        await context2.setConfigValue(Context.configSelfStatus, "My status", ObjectType.String);
        _addListItem(text: "setConfigValue selfstatus My status");
        String getConfigSelfStatusValue2 = await context2.getConfigValue(Context.configSelfStatus);
        _addListItem(text: "getConfigValue selfstatus", assertion: "My status", result: getConfigSelfStatusValue2);
        await context2.setConfigValue(Context.configMailPassword, "secret", ObjectType.String);
        _addListItem(text: "setConfigValue mail_password secret");
        String getConfigMailPasswordValue2 = await context2.getConfigValue(Context.configMailPassword);
...
*/
        ...
        await context.setConfigValue("addr", "alice@mailserver.vagrant", ObjectType.String);
        _addListItem(text: "setConfigValue addr alice@mailserver.vagrant");
        String getConfigAddrValue = await context.getConfigValue("addr");
        _addListItem(text: "getConfigValue addr", assertion: "alice@mailserver.vagrant", result: getConfigAddrValue);
        ...
        await context.setConfigValue(Context.configMailPassword, "secret", ObjectType.String);
        _addListItem(text: "setConfigValue mail_password secret");
        String getConfigMailPasswordValue = await context.getConfigValue(Context.configMailPassword);
        _addListItem(text: "getConfigValue mail_password", assertion: "secret", result: getConfigMailPasswordValue);
        await context.configure();
        _addListItem(text: "configured");

        int contactId = await context.createContact("Bob", "bob@mailserver.vagrant");
        _addListItem(text: "createContact bob@mailserver.vagrant", assertion: 10, result: contactId);
        int contactId2 = await context.createContact(null, "charlie@mailserver.vagrant");
