  ...
  Future<void> initList() async {
    ...
    try {
      ...
      if (init) {
        ...
        await context.setConfigValue("addr", "alice@ox.io");
        ...
        await context.setConfigValue(Context.configDisplayName, "Alice");
        ...
        await context.setConfigValue(Context.configSelfStatus, "My status");
        ...
        await context.setConfigValue(Context.configMailServer, "imap.ox.io");
        ...
        await context.setConfigValue(Context.configMailUser, "alice@ox.io");
        ...
        await context.setConfigValue(Context.configMailPassword, "password");
        ...
        await context.setConfigValue(Context.configMailPort, "148");
        ...
        await context.setConfigValue(Context.configSendServer, "smtp.ox.io");
        ...
        await context.setConfigValue(Context.configSendUser, "alice@ox.io");
        ...
        await context.setConfigValue(Context.configSendPassword, "password");
        ...
        await context.setConfigValue(Context.configSendPort, "931");
