...
struct Argument {
    ...
    static let DIR                         = "dir"
    static let ARGUMENT_MESSAGE_TYPE_ONE   = "messageTypeOne"
    static let ARGUMENT_MESSAGE_TYPE_TWO   = "messageTypeTwo"
    static let ARGUMENT_MESSAGE_TYPE_THREE = "messageTypeThree"
